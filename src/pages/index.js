...
import { ItalicText, Stars } from './styled'
    ...
    <ThemeProvider theme={theme}>
      <GlobalStyles />
        ...
        <Layout>
          <section>
            <Stars />
            <Heading type='h1'>РАСКРЫВАЯ ИСТИННЫЕ ВОЗМОЖНОСТИ <ItalicText>NFT</ItalicText></Heading>
          ...
          <section>
            ...
            <RegularText>Познать то, что нельзя осязать, обонять, ощутить на вкус, услышать ухом и увидеть глазом.</RegularText>
